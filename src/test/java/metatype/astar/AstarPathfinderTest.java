...
public class AstarPathfinderTest extends TestCase {
  public void testRoute() {
    ...
    Vertex[][] grid = createGrid(g, xdim, ydim);
   ...
   * </pre>
   * 
   * All edges are weighted at 1.0 except for the hill (*) which is weighted
   * at 2 * xdim.
   * 
   * @param g
   *          the grid
   ...
   * @return the grid
   */
  private Vertex[][] createGrid(SimpleGraph g, int xdim, int ydim) {
